...
<ul class="channel-boxs">
  <li style=" margin-bottom: 10px; width: 187px; float: left; padding-right: 8px;" v-for="(item, index) in channel" :key="index" draggable="true" @click="handleRouter(item.module, item.module)" @dragend="handleDragEnd($event, item)" @dragstart="handleDragStart($event, item)" @dragenter="handleDragEnter($event, item)" @dragover.prevent="handleDragOver($event, item)">
