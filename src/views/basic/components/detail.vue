<template>
  ...
  <v-drawer
    ...
    :action="action"
    title="信息配置"
    :data="{...data, coding: coding.config}"
    :render="render"
    :submit="submit"
  >
    <template v-slot:content v-if="isShow">
      <ul class="form-wrap-box">
        ...
        <li class="li">
          ...
          <v-select
            :enums="TEXT_TYPE"
            v-model:value="detail.text_type"
            :defaultValue="
              (detail.text_type = detail.text_type ? detail.text_type : 'input')
            "
          />
        </li>
        <li class="li">
        ...
        <li class="li">
          ...
          <v-radio
            ...
            name="isdelete"
            value="0"
            v-model:checked="detail.isdelete"
          />
          <v-radio
            label="否"
            name="isdelete"
        ...
        <li class="li">
          ...
          <v-choose
            ...
            v-model:checked="detail.website"
            type="radio"
            @choose="choose"
          />
        </li>
...
import { codings, getCurrentInstance, ref, useStore } from "@/utils";

import { TEXT_TYPE } from "@/assets/enum";
...
function submit(params: any) {
  const { remark, name, value, text_type, explanation, isdelete, website } =
    detail.value;
