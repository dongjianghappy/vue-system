...
<div class="col-md-4" style="padding-right: 8px;">
  ...
  <div class="col-md-4" style="padding-left: 8px; padding-right: 8px;">
    <div class="col-md-4">
      <v-statisticcard name="累计IP" :value="data.total_ip || 0" />
    </div>
    <div class="col-md-4">
      <v-statisticcard name="昨日IP" :value="data.yesterday && data.yesterday.ip || 0" />
    </div>
    <div class="col-md-4">
      <v-statisticcard name="今日IP" :value="data.today && data.today.ip || 0" />
    </div>
  </div>
  <div class="col-md-4" style="padding-left: 8px;">
    <div class="col-md-6">
      <v-statisticcard name="昨日在线用户" value="2,836" />
    </div>
    <div class="col-md-6">
      <v-statisticcard name="今日在线用户" value="2,836" />
    </div>
  </div>
</template>
