          ...
          <td class="col-md-3">
            <div class="card h70">
              <div class="ant-card-body">
                <span class="quick-edit">{{ item.navname }}</span>
              </div>
            </div>
          </td>
          <td class="col-md-4">
            <div class="card h70">
              <div class="ant-card-body">
                <span class="quick-edit">{{ item.url }}</span>
              </div>
            </div>
          </td>
          <td class="col-md-2">
...
import { onMounted, computed, useStore, useRouter, codings } from "@/utils";
...
function handleclick(type: any, params: any) {
  router.push(
    `/admin/navigation/${type}?channel=${params.id}&name=${params.name}`
  );
}
