  ...
  <template v-slot:content v-if="isShow">
    <ul class="form-wrap-box">
      ...
      <li class="li">
        ...
        {{detail.parent}}
        <v-category name="选择分类" :data="{item: detail, coding: 'C20002'}" type="text"></v-category>
      ...
      <li class="li" v-if="coding.art === 'C20000'">
        <img style="width: 100%" :src="detail.image && detail.image[0]" alt="">
      </li>
    </ul>
    <div class="mb15" style="overflow: hidden;"><v-uploads ref="upload" :data="{id: detail.id, cover: detail.cover,  coding: 'C20000'}" :dataList="detail.img || []" uploadtype="office" @imgList="image" :style="'width: 135px'" /></div>
  </template>
</v-drawer>
</template>
