...
<v-button v-model:show="isShow" :disabled="auth">
  <i class="iconfont icon-anonymous-iconfont" v-if="action === 'add'" />{{action === 'edit'? "编辑": "上传藏品"}}
</v-button>
<v-drawer ref="drawer" v-model:show="isShow" :action="action" :title="action === 'edit' ? '编辑图片' : '上传藏品' " api="articleDetail" :data="{...data, coding: coding.art}" :param="detail" :render="render" :submit="submit">
