...
<v-button v-model:show="isShow" :disabled="auth">
  ...
  <template v-else>
  <i class="iconfont icon-anonymous-iconfont" v-if="action === 'add'" />{{action === 'edit'? "编辑": "新增词句"}}
  </template>
</v-button>
<v-drawer ref="drawer" v-model:show="isShow" :action="action" :title="action === 'edit' ? '编辑词句' : '新增词句' " drafts="true" api="articleDetail" :data="{...data, coding: data.coding.art || data.coding}" :render="render" :submit="submit">
