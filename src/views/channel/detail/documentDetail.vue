...
<v-button v-model:show="isShow" :disabled="auth">
  ...
  <template v-else>
  <i class="iconfont icon-anonymous-iconfont" v-if="action === 'add'" />{{action === 'edit'? "编辑": "上传文档"}}
  </template>
</v-button>
<v-drawer ref="drawer" v-model:show="isShow" :action="action" :title="action === 'edit' ? '编辑文档' : '上传文档' " drafts="true" api="articleDetail" :data="{...data, coding: data.coding.art || data.coding}" :render="render" :submit="submit">
