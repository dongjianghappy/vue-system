  ...
  <template v-slot:content v-if="isShow">
    <ul class="form-wrap-box">
      <li class="li clearfix">
        ...
        <div class="col-md-2 pl25">
          <v-category name="选择歌手" :data="{detail, coding}" type="text" api="delete"></v-category>
        </div>
        <div class="col-md-2 pl25">
          <v-category name="选择专辑" :data="{detail, coding}" type="text" api="delete"></v-category>
        </div>
        <div class="col-md-2 pl25">
          <v-category name="歌词" :data="{detail, coding}" type="text" api="delete"></v-category>
        </div>
        <div class="col-md-3 pl25 align_right">
          <v-uploadfile uploadtype="music" />
        </div>
      </li>
      <li class="li">
